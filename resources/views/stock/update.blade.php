        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <p class="mb-4">Stock Item<a target="_blank"> </a></p>
                            ...
                            <div class="p-5">
                                <form action="{{ route('stock.update', $stock->id) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="number" name="stock" class="form-control form-control-user" placeholder="Stock" value="{{ old('stock', $stock->stock) }}">
                                        </div>
                                    </div>
                                    <hr>
